...
namespace MarketBackend.Migrations
{
    ...
    [Migration("20251210204442_SellerApplicationUpdate")]
    partial class SellerApplicationUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarketBackend.Models.Coupon", b =>
                {
            ...
            modelBuilder.Entity("MarketBackend.Models.SellerApplication", b =>
                {
            ...
            modelBuilder.Entity("MarketBackend.Models.Coupon", b =>
                {
                    b.HasOne("MarketBackend.Models.Brand", null)
                        .WithMany("Coupons")
                        .HasForeignKey("BrandId");

                    b.HasOne("MarketBackend.Models.AppUser", "CreatedByAdmin")
                        .WithMany("CreatedAdminCoupons")
                        .HasForeignKey("CreatedByAdminId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("MarketBackend.Models.AppUser", "CreatedBySeller")
                        .WithMany("CreatedSellerCoupons")
            ...
            modelBuilder.Entity("MarketBackend.Models.ShoppingCart", b =>
                {
                    ...
                    b.HasOne("MarketBackend.Models.Coupon", "AppliedCoupon")
                        .WithMany()
                        .HasForeignKey("AppliedCouponCode")
            ...
            modelBuilder.Entity("MarketBackend.Models.AppUser", b =>
                {
                    ...
                    b.Navigation("CreatedAdminCoupons");
